Feature: Project 5 automation
  ...
  Scenario: Test case 01: Validate the main content
    ...
    Scenario: Test case 2: Validate the Pagination Next/Previous buttons
      ...
      Scenario: Test case 3: Validate the Pagination Cities content
